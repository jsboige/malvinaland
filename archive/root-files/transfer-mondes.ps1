# Script pour transférer le contenu détaillé des mondes de Site/Mondes vers les pages à la racine du site

# Liste des mondes à traiter (nous avons déjà traité l'assemblée et la grange)
$mondes = @(
    @{Source="Le monde des jeux"; Destination="monde-jeux"},
    @{Source="Le monde des rêves"; Destination="monde-reves"},
    @{Source="Le monde du damier"; Destination="monde-damier"},
    @{Source="Le monde du linge"; Destination="monde-linge"},
    @{Source="Le monde du verger"; Destination="monde-verger"},
    @{Source="Le monde du Zob"; Destination="monde-zob"},
    @{Source="Le monde Elysée"; Destination="monde-elysee"},
    @{Source="Le monde Karibu"; Destination="monde-karibu"},
    @{Source="Le monde orange des Sphinx"; Destination="monde-sphinx"}
)
...
Write-Host "Transfert terminé pour tous les mondes" -ForegroundColor Green